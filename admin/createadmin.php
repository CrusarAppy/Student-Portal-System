  ...
  <ul>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<form method="post" action="">
			...
			<input type="submit" name="submit1" value="Create this admin"><br>		
		</form>
    </div>
    <?php
	    if (isset($_POST["submit1"])){
			...
			$name=$_POST["name"];
			$email=$_POST["email"];
			$sql="INSERT INTO commoninfo (Name,Username,Password,Email,AccountType) values ('$name','$username','$password','$email','admin')";
