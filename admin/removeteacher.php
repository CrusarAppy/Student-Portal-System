...
<style>
  ...
  <ul>
	...
	//allcode inside this div -->
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<form method="post" action ="">
			<input type="text" placeholder="username" name="username">
			<input type ="submit" name="submit1" value="delete teacher with this username">
		</form>
    </div>
    <?php
  	if(isset($_POST['submit1'])){
  		$username=$_POST['username'];
  		$sql="DELETE FROM `commoninfo` WHERE Username='$username' and AccountType='teacher'";
